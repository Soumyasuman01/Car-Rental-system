...
$vehicle_or = $_FILES["OR"]["name"];
$vehicle_cr = $_FILES["CR"]["name"];
...
$sql="INSERT INTO tblvehicles(user_id, VehiclesTitle,VehiclesBrand,VehiclesOverview,PricePerDay,FuelType,ModelYear,SeatingCapacity,Vimage1,Vimage2,Vimage3,Vimage4,Vimage5,AirConditioner,PowerDoorLocks,AntiLockBrakingSystem,BrakeAssist,PowerSteering,DriverAirbag,PassengerAirbag,PowerWindows,CDPlayer,CentralLocking,CrashSensor,LeatherSeats,lat,lng, vehicle_or, vehicle_cr) VALUES(:uid, :vehicletitle,:brand,:vehicleoverview,:priceperday,:fueltype,:modelyear,:seatingcapacity,:vimage1,:vimage2,:vimage3,:vimage4,:vimage5,:airconditioner,:powerdoorlocks,:antilockbrakingsys,:brakeassist,:powersteering,:driverairbag,:passengerairbag,:powerwindow,:cdplayer,:centrallocking,:crashcensor,:leatherseats, (SELECT LenderLat FROM tblusers WHERE id=:uid),(SELECT LenderLng FROM tblusers WHERE id=:uid), :vehicle_or, :vehicle_cr)";
...
$query->bindParam(':vehicle_or',$vehicle_or,PDO::PARAM_STR);
$query->bindParam(':vehicle_cr',$vehicle_cr,PDO::PARAM_STR);
$query->execute();
...
<div class="hr-dashed"></div>
	...
	<div class="form-group">
		<div class="col-sm-4">
			OR (fficial Receipt) <span style="color:red">*</span><input type="file" name="OR" required>
		</div>
		<div class="col-sm-4">
			CR (Certificate of Registration) <span style="color:red">*</span><input type="file" name="CR" required>
		</div>
	</div>
</div>
</div>
