...
<div class="form-group">
<div class="col-sm-4">
Image 1 <br><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>"><br> Change Image 1</a>
</div>
<div class="col-sm-4">
Image 2
<br>
<img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>"><br> Change Image 2</a>
</div>
<div class="col-sm-4">
Image 3
<br>
<img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>"><br> Change Image 3</a>
</div>
</div>
...
<div class="row">
<div class="col-sm-4">
Image 4<br><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage4);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>"><br> Change Image 4</a>
</div>
<div class="col-sm-4">
Image 5
<br> <?php if($result->Vimage5=="")
{
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>"><br> Change Image 5</a>
<?php } ?>
</div>
...
<div class="form-group">
	<div class="col-sm-4">
		OR (Official Receipt) <br> <img src="admin/img/documents/<?php echo htmlentities($result->vehicle_or);?>" alt="Official Receipt" width="300" height="200" style="border: solid 1px #000">
		<a href="changevehicle_or.php?imgid=<?php echo htmlentities($result->id)?>"><br> Change OR</a>
	</div>
	<div class="col-sm-4">
	CR (Certificate of Registration) <br> <img src="admin/img/documents/<?php echo htmlentities($result->vehicle_cr);?>" alt="Certificate of Registration" width="300" height="200" style="border: solid 1px #000">
	<a href="changevehicle_cr.php?imgid=<?php echo htmlentities($result->id)?>"><br> Change CR</a>
	</div>
</div>
